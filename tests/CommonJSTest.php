...
class CommonJSTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRawModulesClasses ()
    {
        $commonJs = include __DIR__ . '/../commonjs.php';
        $require = $commonJs['require'];
        $commonJs['config']['basePath'] = __DIR__;
        ...
        $this->assertEquals('Foo', ''.$fooInstance);
    }

    public function testAutomaticallyNamespacedModulesClassesWithoutCollision ()
    {
        $commonJs = include __DIR__ . '/../commonjs.php';
        $require = $commonJs['require'];
        $commonJs['config']['basePath'] = __DIR__;
        $commonJs['config']['autoNamespacing'] = true;
        ...
        $fooFactoryModule = $require('module-dir/classes/package/foo-factory');
        $fooInstanceWithFactory = call_user_func($fooFactoryModule['getInstance']);
        $this->assertEquals('CommonJS\Module\module_dir\classes\package\foo_factory\Foo', ''.$fooInstanceWithFactory);
